...
LangGraphとGraflowの違いは、単なるAPIの差ではなく、**「ワークフローを静的に定義するか、動的に構築するか」** という設計思想の違いです。
...
GraflowはApache 2.0ライセンスのOSSです。[GitHub](https://github.com/GraflowAI/graflow)でのIssue報告やPull Requestも歓迎しています。リリース情報や最新の情報発信は、X（旧Twitter）アカウント [@GraflowAI](https://x.com/GraflowAI) をフォロー頂ければと思います。
